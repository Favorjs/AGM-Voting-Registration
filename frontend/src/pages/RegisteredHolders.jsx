  ...
  const exportToExcel = async () => {
    try {
      ...
      const response = await fetch(
        `https://e-voting-backeknd-production-077c.up.railway.app/api/${endpoint}?page=1&pageSize=${pagination.totalItems || 1000}&sortBy=registered_at&sortOrder=desc&search=${searchTerm}`,
        {
          headers: {
